...
const upData = reactive({
  new: [
    "增加 音乐播放器（点击 一言 上方的 “来点儿音乐？”）",
    "增加 域名重定向 home.guangzhoueven.dpdns.org",
    "更改 域名 为 www.guangzhoueven.dpdns.org",
  ],
  fix: ["采用 Vue 进行重构", "音乐歌单支持快速自定义", "壁纸支持个性化设置", "音乐播放器支持音量控制", "修复天气 API", "时光胶囊显示错误", "移动端动画及细节", "图标更换为 IconPark"],
});
